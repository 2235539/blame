...
program solves the given problem. The missed keywords, expressions or statements are identified as ITEM 1,
ITEM 2, ..., ITEM 7. Encode and test the completed program.
**/
import java.util.*;
...
//Show the taxable income by invoking the showResults method
   ...
   public static void showIntroduction() { // ITEM 1
       ...
       System.out.println("------------------------------------");
       System.out.println("This program is for the computation of the tax due from a taxpayer " +
