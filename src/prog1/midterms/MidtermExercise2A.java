...
>= 90 but <= 100 A
Activities:
1. Based on the following algorithm for the above programming problem, provide the statements or
expressions that should replace the blank lines in the incomplete program given below. The statements or
expressions should be based on the given parts of the program. (You should not
add any statement or expression aside from those that should replace the blank lines.) One
blank line corresponds to one statement or one expression. (Filename: MidtermExercise2A.java)
...
public class MidtermExercise2A {
    public static void main(String[] args) {
        ...
        if (numericGrade >= 90 && numericGrade <= 99) {
            letterGrade = 'A';; // 10
        }
